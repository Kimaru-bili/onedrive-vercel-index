...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'kimaru@rmm6.onmicrosoft.com',
  ...
  protectedRoutes: ['/MMD/MMD资源'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'mailto:hengqingkai@gmail.com',
  ...
  links: [
    ...
    {
      name: 'Telegram',
      link: 'https://t.me/+7g9cd6zDFZoyOWU1',
    },
  ],
